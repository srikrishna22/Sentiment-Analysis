...
sentapp <- function(){
  ...
  server <- function(input, output) {
    ...
    positive = scan('./SentAnalysis/rawdata/positive-words.txt', what='character', comment.char=';')
    negative = scan('./SentAnalysis/rawdata/negative-words.txt', what='character', comment.char=';')
